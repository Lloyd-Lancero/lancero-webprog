      ...
      <section className="drop-shadow-md bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
          <div className="rounded-3xl bg-zinc-100 overflow-hidden">
            <img src={header2} className= 'object-contain w-full h-full' />
            </div>
            <div>
        ...
        <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            ...
            <div className="mt-6 space-y-4">
              <article className="rounded-3xl drop-shadow-md bg-zinc-100 p-5">
          ...
          <div className="rounded-3xl drop-shadow-md bg-zinc-100 p-5">
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              <div className="flex aspect-square items-center justify-center rounded-[1.25rem] bg-zinc-200">
                <img src={wireframe1} className= 'object-contain w-full h-full' /> 
              </div>
              <div className="flex aspect-square items-center justify-center rounded-[1.25rem] bg-zinc-200">
                <img src={wireframe2} className= 'object-contain w-full h-full' />
              </div>
              <div className="flex aspect-square items-center justify-center rounded-[1.25rem] bg-zinc-200">
                <img src={wireframe3} className= 'object-contain w-full h-full' />
              </div>
              <div className="flex aspect-square items-center justify-center rounded-[1.25rem] bg-zinc-200">
                <img src={wireframe4} className= 'object-contain w-full h-full' />
              </div>
            </div>
